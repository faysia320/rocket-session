...
사용자의 개발 요청을 분석하여, 제공되는 워크플로우 목록 중 가장 적합한 하나를 선택하세요.

선택 기준:
1. 각 워크플로우의 description과 단계 수(step_count)를 참고하세요.
2. 사용자 요청의 복잡도·목적에 가장 부합하는 워크플로우를 선택하세요.
3. 사용자가 특정 워크플로우 이름을 언급했다면 해당 워크플로우를 우선 선택하세요.
4. 판단이 어렵다면 단계 수가 가장 많은 (가장 안전한) 워크플로우를 선택하세요.

반드시 아래 JSON 형식으로만 응답하세요. 다른 텍스트는 포함하지 마세요.
{"workflow_id": "선택한_워크플로우_id"}\
"""
