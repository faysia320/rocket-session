...
@pytest_asyncio.fixture
async def mcp_service(db):
    """McpService fixture."""
    return McpService(db)


@pytest_asyncio.fixture
async def analytics_service(db):
    """AnalyticsService fixture."""
    return AnalyticsService(db)


@pytest_asyncio.fixture
async def workflow_definition_service(db):
    """WorkflowDefinitionService fixture."""
    return WorkflowDefinitionService(db)


@pytest_asyncio.fixture
async def workspace_service(db, git_service):
    """WorkspaceService fixture."""
    return WorkspaceService(db, git_service, workspaces_root="/tmp/test-workspaces")
