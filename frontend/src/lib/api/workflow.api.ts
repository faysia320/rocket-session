...
export const workflowApi = {
  ...
  listArtifacts: (sessionId: string) =>
    api.get<SessionArtifactInfo[]>(
      `${base(sessionId)}/artifacts`,
    ),

  getArtifact: (sessionId: string, artifactId: number) =>
    api.get<SessionArtifactInfo>(
      `${base(sessionId)}/artifacts/${artifactId}`,
    ),
  ...
  addAnnotation: (
    ...
    api.post<ArtifactAnnotationInfo>(
      `${base(sessionId)}/artifacts/${artifactId}/annotations`,
      req,
    ),
