    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <div className="flex items-center gap-1.5 cursor-default">
          ...
          <span className={cn(
            'font-mono text-[10px]',
            pct >= 90 ? 'text-destructive font-semibold' : pct >= 75 ? 'text-warning' : 'text-muted-foreground',
          )}>
            {pct.toFixed(0)}%
          </span>
        ...
        <div className="space-y-0.5">
          ...
          {estimate ? (
            <div className="pt-0.5 border-t border-border">
              ...
              <div className={cn(
                estimate.remainingTurns <= 2 ? 'text-destructive' :
                estimate.remainingTurns <= 5 ? 'text-warning' : 'text-muted-foreground',
              )}>
