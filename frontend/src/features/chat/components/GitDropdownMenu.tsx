...
import { GitBranch, GitCommitHorizontal, GitPullRequest, GitMerge, Trash2 } from "lucide-react";
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" size="icon" aria-label="Git 작업">
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="font-mono text-xs">
                이 워크트리 디렉토리와 연결된 브랜치가 삭제됩니다. 미커밋 변경사항이 있으면 강제
                삭제됩니다. 원격 브랜치(origin)도 함께 삭제됩니다.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
