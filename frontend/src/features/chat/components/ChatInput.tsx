    ...
    >
      <div className="relative">
        ...
        >
          ...
          <Textarea
            ref={textareaRef}
            className="flex-1 font-mono text-lg md:text-sm bg-transparent border-0 outline-none resize-none min-h-9 leading-[20px] py-2 focus-visible:ring-0 focus-visible:ring-offset-0"
            value={input}
